...
`reF1nd/sing-box`, check out the selected upstream release tag, apply
`patches/provider.patch`, build a single Android arm64 `sing-box` binary, and
publish it to this repository's Releases.
